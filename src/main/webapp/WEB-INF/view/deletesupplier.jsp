...
<center>
 <form:form class="form-inline" action="validatedeletesupplier" method="post" commandname="Supplier">
   <div class="form-group " >
 
 
    <form:input type="text" class="form-control" placeholder="ENTERTHESUPPLIERID" path="id" name="id" />
